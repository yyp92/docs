...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-4.png)
...
![](../../\imgs\interview-performance-5.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-6.png)

而具体到**图片**这一类的资源，平均请求体积是这样的：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-7.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-8.png)

京东首页也不例外：

![](../../\imgs\interview-performance-9.png)
...
![](../../\imgs\interview-performance-10.png)

较小的 Logo：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-11.png)

颜色简单、对比度较强的透明小图也在 PNG 格式下有着良好的表现：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-12.png)
...
![](../../\imgs\interview-performance-13.png)
...
![](../../\imgs\interview-performance-14.png)
...
![](../../\imgs\interview-performance-15.png)
...
![](../../\imgs\interview-performance-16.png)
...
![](../../\imgs\interview-performance-17.png)
...
![](../../\imgs\interview-performance-18.png)

我们给 `size` 这一栏一个特写：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-19.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-20.png)
...
![](../../\imgs\interview-performance-21.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-22.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-23.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-24.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-25.png)
...
![](../../\imgs\interview-performance-26.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-27.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-28.png)
...
![](../../\imgs\interview-performance-29.png)

我们点击 preview，可以看到业务服务器确实是返回给了我们一个尚未被静态资源加持过的简单 HTML 页面，所有的图片内容都是先以一个 div 占位：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-30.png)

相应地，我们随便点开一个静态资源，可以看到它都是从 CDN 服务器上请求来的。

比如说图片：

![](../../\imgs\interview-performance-31.png)

再比如 JS、CSS 文件：

![](../../\imgs\interview-performance-32.png)

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-33.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-34.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-35.png)
...
![](../../\imgs\interview-performance-36.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-37.png)
...
![](../../\imgs\interview-performance-38.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-39.png)
...
![](../../\imgs\interview-performance-40.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-41.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-42.png)
...
![](../../\imgs\interview-performance-43.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-44.png)
...
![](../../\imgs\interview-performance-45.png)
...
![](../../\imgs\interview-performance-46.png)

大家留意一栏文章右侧可能会出现的图片，这里咱们给个特写：

![](../../\imgs\interview-performance-47.png)
...
![](../../\imgs\interview-performance-48.png)
...
![](../../\imgs\interview-performance-51.png)
...
![](../../\imgs\interview-performance-52.png)
...
![](../../\imgs\interview-performance-53.png)
...
![](../../\imgs\interview-performance-54.png)

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-55.png)

**2. 简要分析**

这里我打开掘金首页，选中 `Performance` 面板中的圆箭头，来看一下页面加载过程中的性能表现：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-56.png)

从上到下，依次为概述面板、详情面板。下我们先来观察一下概述面板，了解页面的基本表现：

![](../../\imgs\interview-performance-57.png)
...
![](../../\imgs\interview-performance-58.png)
...
![](../../\imgs\interview-performance-59.png)
...
![](../../\imgs\interview-performance-64.png)
...
![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-65.png)

**2. 关键时间节点**

在 `performance` 的 `timing` 属性中，我们可以查看到如下的时间戳：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-66.png)

这些时间戳与页面整个加载流程中的关键时间节点有着一一对应的关系：

![](C:\Users\Administrator\Desktop\docs\imgs\interview-performance-67.png)
