...
![](C:\Users\Administrator\Desktop\docs\imgs\webpack-dev-1.png)
...
如果作为命令行启动，`webpack-dev-server/bin/webpack-dev-server.js` 就是整个命令行的入口。贴出来的代码进行了一些精简，忽略了一些非核心的分支处理，只关心 webpack-dev-server 的核心逻辑。可以按照注释标注的顺序简单阅读下代码。
